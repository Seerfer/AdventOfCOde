...
class Test_Board_calculate_borders(unittest.TestCase):
    ...
    def test_Board_calculate_possible_borders(self):
        ...
        self.assertEqual(
            set(self.board._calculate_possible_borders(input_x, input_y)), set(expected)
        )
